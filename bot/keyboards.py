...
class BotKeyboards:
    ...
    def get_curtain_subcategories(self, page: int = 0) -> InlineKeyboardMarkup:
        ...
        nav_row = []
        total_pages = (len(product_icons) + items_per_page - 1) // items_per_page
        
        if page > 0:
            nav_row.append(InlineKeyboardButton("⬅️ صفحه قبل", 
                                              callback_data=f"curtain_page_{page-1}"))
        
        if page < total_pages - 1:
            nav_row.append(InlineKeyboardButton("➡️ صفحه بعد", 
                                              callback_data=f"curtain_page_{page+1}"))
    ...
    def get_tablecloth_subcategories(self, page: int = 0) -> InlineKeyboardMarkup:
        ...
        if page > 0:
            nav_row.append(InlineKeyboardButton("⬅️ صفحه قبل", 
                                              callback_data=f"tablecloth_page_{page-1}"))
    ...
    def get_alphabetical_keyboard(self, category: str, page: int = 0) -> InlineKeyboardMarkup:
        ...
        # Add pagination buttons
        nav_row = []
        total_pages = (len(PERSIAN_ALPHABET) + letters_per_page - 1) // letters_per_page
